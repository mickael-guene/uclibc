...
- p1 is a pointer to the start of .rofixup section
- p2 is a pointer to the last word of .rofixup section
...
*/
	    ...
	    "  bl      __self_reloc;\n"
	    "  pop {r7, r8, r9, r10}\n"
/* we compute parameters for dl_start(). See DL_START() macro below for list
   address of user entry point is return in dl_main_funcdesc(on stack) */
	    "  mov r1, r7\n"
	    "  mov r2, r8\n"
	    "  mov r3, r9\n"
	    "  mov r4, sp\n"
...
// we use __aeabi_ldiv0 somwhere and so we need to have raise symbol
int raise(int sig)
{
  _dl_exit(1);
}
